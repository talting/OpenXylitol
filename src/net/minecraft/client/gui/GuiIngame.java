    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.titlesTimer > 0) {
            ...
            if (i2 > 8) {
                ...
                this.displayedTitle = org.apache.commons.lang3.StringUtils.replace(this.displayedTitle, "花雨庭", "Quick Macro");
...
//        KawaseBloom.shadow(() -> , 3, 1);
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        for (Score score1 : collection) {
            ...
            if (j == 1) {
                this.getFontRenderer().drawString(EnumChatFormatting.GOLD + "quickmacro.com", l1, k, 553648127);
            ...
            if (j == collection.size()) {
                String s3 = org.apache.commons.lang3.StringUtils.replace(org.apache.commons.lang3.StringUtils.replace(objective.getDisplayName(), "花雨庭", "Quick Macro"), "§c✿", "§c⌨");
