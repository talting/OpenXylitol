...
*/
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        if (this.header != null) {
            list1 = this.mc.fontRendererObj.listFormattedStringToWidth(this.header.getFormattedText().replace("花雨庭", "Quick Macro").replace("❀", "⌨").replace("www.mchyt.com", "www.quickmacro.sb"), width - 50);
        ...
        if (this.footer != null) {
            list2 = this.mc.fontRendererObj.listFormattedStringToWidth(this.footer.getFormattedText().replace("www.mchyt.com", "www.quickmacro.sb"), width - 50);
