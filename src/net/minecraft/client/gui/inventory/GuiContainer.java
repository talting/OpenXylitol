...
import cc.xylitol.module.impl.player.ChestStealer;
        ...
        if (stealer.getState() && stealer.silentValue.getValue()) {
            if (guiScreen instanceof GuiChest) {
                ...
                if (!(stealer.silentValue.getValue() && (chest.lowerChestInventory == null))) {
                    ...
                    // hide GUI
                    RenderUtil.drawLoadingCircle(sr.getScaledWidth() / 2, sr.getScaledHeight() / 2.0F + 25);
                    String tipString = "Stealing";

                    FontManager.font18.drawString(tipString,
                            (width / 2F) - (FontManager.font18.getStringWidth(tipString) / 2F),
