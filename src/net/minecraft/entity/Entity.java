...
public abstract class Entity implements ICommandSender {
    ...
    public cc.xylitol.utils.vector.Vector3d getCustomPositionVector() {
        return new cc.xylitol.utils.vector.Vector3d(posX, posY, posZ);
    }
    /**
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        Client.instance.eventManager.call(eventStrafe);
