...
import cc.xylitol.module.impl.move.FastLadder;
import cc.xylitol.module.impl.move.NoJumpDelay;
import cc.xylitol.module.impl.move.NoLiquid;
  ...
  //  }
    ...
    public void moveEntityWithHeading(float strafe, float forward) {
        if (this.isServerWorld()) {
            if (!(this.isInWater() && !NoLiquid.shouldCancelWater) || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                if (!(this.isInLava() && !NoLiquid.shouldCancelWater) || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                    float f4 = 0.91F;
    ...
    public void onLivingUpdate() {
        ...
        NoJumpDelay nojumpdelay = Client.instance != null ? Client.instance.getModuleManager().getModule(NoJumpDelay.class) : null;

        if (nojumpdelay != null && Minecraft.getMinecraft().thePlayer != null) {
