...
import cc.xylitol.utils.render.waveycapes.config.Config;
import cc.xylitol.utils.render.waveycapes.sim.StickSimulation;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public float getEyeHeight()
    {
        ...
        if (enableCameraYOffset)
            f = (float) (1.62F - (Minecraft.getMinecraft().thePlayer.lastTickPosY + (((Minecraft.getMinecraft().thePlayer.posY - Minecraft.getMinecraft().thePlayer.lastTickPosY) * Minecraft.getMinecraft().timer.renderPartialTicks)) - y));
